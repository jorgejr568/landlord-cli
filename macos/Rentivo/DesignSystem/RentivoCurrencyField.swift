...
///
/// Unlike the iOS field this one sets no keyboard type: macOS has a hardware keyboard, so
/// non-digit input is filtered on change rather than prevented at the keyboard.
