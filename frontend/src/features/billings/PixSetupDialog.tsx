          ...
          <form className="pix-setup-dialog__form" onSubmit={(event) => void savePix(event)}>
            ...
            <div className="pix-setup-dialog__row">
              <div className="field">
                ...
                {errors.name ? <FieldError id="quick-pix-name-error" message={errors.name} /> : <span className="field__hint" id="quick-pix-name-hint">Como o nome aparecerá na fatura.</span>}
              </div>
              <div className="field">
                ...
                {errors.city ? <FieldError id="quick-pix-city-error" message={errors.city} /> : <span className="field__hint" id="quick-pix-city-hint">Até 15 caracteres, sem acentos.</span>}
              </div>
            </div>
