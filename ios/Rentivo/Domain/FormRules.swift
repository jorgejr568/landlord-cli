...
public enum PixFormRules {
  public static func result(
    ...
    guard name.count <= 25, city.count <= 15 else {
...
public enum CommunicationFormRules {
  ...
  public static func issues(subject: String, body: String) -> [ValidationIssue] {
    ...
    } else if subject.count > maximumSubjectCount {
      issues.append(
...
public enum MoneyInputRules {
  ...
  /// digits keeps pasted overflow from being interpreted as zero by integer conversion.
  public static let maximumSignificantDigits = 9
  ...
  public static func centavos(from text: String) -> Int {
    ...
    return Int(significant.prefix(maximumSignificantDigits)) ?? 0
  }
}
