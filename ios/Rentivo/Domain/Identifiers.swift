...
public struct FileUpload: Hashable, Sendable {
  ...
  /// Claims a document-picker URL and performs its potentially blocking metadata/data reads on
  /// Swift's generic executor instead of inheriting a SwiftUI caller's main-actor isolation.
